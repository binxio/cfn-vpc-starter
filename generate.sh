...
jinja2 vpc.yml.j2 data/layered-2az.yml --format=yaml > templates/layered-2az.yml
...
jinja2 vpc.yml.j2 data/2-layer-2az.yml --format=yaml > templates/2-layer-2az.yml
